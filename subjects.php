                              ...
                              <?php
                                    ...
                                    ?>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <a href="edit-subject.php?id=<?php echo $course['id']; ?>" class="btn btn-sm bg-success-light mr-2">
                                                      <i class="fas fa-pen"></i>
                                                   </a>
                                                   <a href="subjects.php?id=<?php echo $course['id']; ?>" class="btn btn-sm bg-danger-light" onClick="return confirm('Do you really want to delete');">
                                                      <i class="fa fa-trash"></i></a>
                                                    
                                                      <a href="subject-details.php?user_id=<?php echo $course['id']; ?>" class="btn btn-outline-info btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
