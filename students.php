                                             ...
                                             <td>
                                                <div>
                                                   ...
                                                   <a href="students.php?id=<?php echo $user['id']; ?>" class="btn btn-sm bg-danger-light" onClick="return confirm('Do you really want to delete');">
                                                      ...
                                                      <a href="student-details.php?user_id=<?php echo $user['id']; ?>" class="btn btn-outline-info btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
